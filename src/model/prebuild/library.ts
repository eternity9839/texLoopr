...
export const PREBUILD_RECIPES: PrebuildRecipe[] = [
  ...
  {
    id: "signature",
    label: "Signature (open)",
    blurb: "Blank sign-here pad + closing",
    w: 240,
    h: 120,
    build: ({ x, y }) => [
  ...
  {
    id: "signature-preset",
    label: "Signature (prefilled)",
    blurb: "Prefilled ink + identity caption",
    w: 240,
    h: 120,
    build: ({ x, y }) => [
      text("Closing", x, y, 240, 24, "Kind regards,", { fontSize: 12 }),
